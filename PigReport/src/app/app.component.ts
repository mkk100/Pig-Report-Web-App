...
import { Coordinates } from './custom1/view1/add-location/coordinates';
...
export class AppComponent implements AfterViewInit {
  ...
  ngOnint(): void {
    this.http.get<Coordinates>('https://272.selfip.net/apps/VTJlUDzrwx/collections/272-data/documents/')
      .subscribe((data: any) => {
        console.log(data)
      })
